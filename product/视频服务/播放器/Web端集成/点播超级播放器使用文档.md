...
```
 ...
 <!--如果需要在 Chrome 和 Firefox 等现代浏览器中通过 H5 播放 DASH 格式的视频，需要在 tcplayer.v4.1.min.js 之前引入 dash.2.9.3.js。-->
 <script src="https://imgcache.qq.com/open/qcloud/video/tcplayer/libs/dash.2.9.3.js"></script>
 <!--播放器脚本文件-->
...
```
 ...
 <!--如果需要在 Chrome 和 Firefox 等现代浏览器中通过 H5 播放 DASH 格式的视频，需要在 tcplayer.v4.1.min.js 之前引入 dash.2.9.3.js。-->
 <script src="https://cloudcache.tencent-cloud.com/open/qcloud/video/tcplayer/libs/dash.2.9.3.js"></script>
 <!--播放器脚本文件-->
